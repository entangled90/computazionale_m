...
\begin{figure}[h]
	...
	\includegraphics[scale=0.22]{potts/mag100.png}
	}
 	\subfigure[Energia]{
...
\begin{figure}[h]
 	\subfigure[$\beta=0.7$]{
	\includegraphics[scale=0.4]{potts/PDFM07.png}
	}
 	\subfigure[$beta=0.99$]{
	\includegraphics[scale=0.4]{potts/PDFM099.png}
	}
...
\begin{figure}[h]
 	\subfigure[$\beta=1$]{
	\includegraphics[scale=0.4]{potts/PDFM1.png}
	}
 	\subfigure[$beta=1.01$]{
	\includegraphics[scale=0.4]{potts/PDFM101.png}
	}
