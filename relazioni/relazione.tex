...
\begin{figure}[hb]
	\centering
	\includegraphics[scale=0.6]{sfere2D/boltzmann.png}
\end{figure}
...
Si è rappresentata la seguente osservabile, calcolata attraverso la formula\footnote{Valida in unità di misura adimensionate: $V=1$,$k=1$,$m=1$}
$$
	\frac{P V_0}{n T} \, =\,  \frac{P}{nT}\frac{\eta}{\eta_0} \, = 1 + \frac{\sigma}{3 K_{en} t_{tot}} \sum_{coll} | \Delta v_{ij}| 
$$
