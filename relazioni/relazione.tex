...
\begin{figure}[ht]
	\centering
	\subfigure[Grafico completo]{	
	\includegraphics[scale=0.5]{sfere2D/pression.png}
	}
	\subfigure[Particolare della transizione di fase]{
	\includegraphics[scale=0.5]{sfere2D/pressionzoom.png}
	}	
...
\begin{figure}
	...
	\includegraphics[scale=0.55]{sfere2D/tc.png}
	}
	\subfigure[Ingrandimento nella zona di transizione]{
	\includegraphics[scale=0.55]{sfere2D/tczoom.png}
	}
