...
Il valore limite viene raggiunto (nel tempo per cui è stato simulato il sistema) solo nel caso di temperatura più alta. Si può vedere inoltre come la pendenza della curva a temperatura più bassa sia sempre minore della pendenza dell'altra curva.
